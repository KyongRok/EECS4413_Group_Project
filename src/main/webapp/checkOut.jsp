					...
					<div class="checkout_details_area mt-50 clearfix">
						...
						<form action="#" method="post">
							<div class="row">
								...
								<div class="col-12 mb-3">
									<label for="postcode">ZIP <span></span></label> <input
										type="text" class="form-control" id="postcode" value="" />
								</div>
								<div class="col-12 mb-3">
									<label for="city">City<span>*</span></label> <input type="text"
								...
								<div class="col-12">
									<div class="custom-control custom-checkbox d-block mb-2">
										<input type="checkbox" class="custom-control-input"
											...
											for="customCheck1">Agree to Terms</label>
									</div>
					...
					<div class="order-details-confirmation">
						...
						<ul class="order-details-form mb-4">
							...
							<c:forEach items="${sessionScope.cart.cartItems}" var="cartItems">
								<li><span>${cartItems.itemName} ,
										${cartItems.quantity}</span> <span>${cartItems.price}</span></li>
						...
						<div id="accordion" role="tablist" class="mb-4">
							...
							<div class="card">
								...
								<div id="collapseThree" class="collapse" role="tabpanel"
									...
									<div class="card-body">
										<label for="credit_card">Card Number: <span>*</span></label> <input
											type="text" class="form-control mb-3" id="credit_card"
											value="" required="required"/>
											<label for="cvv">CVV: <span>*</span></label> <input
											type="text" class="form-control mb-3" id="cvv"
											value="" required="required"/>
